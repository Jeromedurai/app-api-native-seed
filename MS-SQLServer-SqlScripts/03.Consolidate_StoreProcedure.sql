...
IF OBJECT_ID(N'[dbo].[SP_ADMIN_UPDATE_USER_STATUS]', N'P') IS NOT NULL
	DROP PROCEDURE [dbo].[SP_ADMIN_UPDATE_USER_STATUS];
GO
...
CREATE PROCEDURE [dbo].[SP_GET_IMAGE_BY_ID]
	@ImageId BIGINT
AS
BEGIN
	SET NOCOUNT ON;
...
GO
-- USING
CREATE PROCEDURE [dbo].[SP_ADD_IMAGE_LIST]
	@ProductId BIGINT,
...
CREATE PROCEDURE [dbo].[SP_GET_PRODUCT_LIST_FILTERED]
	@TenantId BIGINT,
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_GET_USER_WISHLIST_ITEMS]
	@UserId BIGINT,
	@TenantId BIGINT = NULL
AS
BEGIN
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_CLEAR_WISHLIST]
	@UserId BIGINT,
	@TenantId BIGINT = NULL,
	@ClearCompletely BIT = 1,
	@IpAddress NVARCHAR(45) = NULL,
...
CREATE PROCEDURE [dbo].[SP_ADMIN_UPDATE_USER_STATUS]
				@AdminUserId BIGINT,
				@UserId BIGINT,
				@TenantId BIGINT = NULL,
				@Status NVARCHAR(50),
...
CREATE PROCEDURE [dbo].[SP_CREATE_RAZORPAY_ORDER]
	@Amount BIGINT,
...
CREATE PROCEDURE [dbo].[SP_VERIFY_RAZORPAY_PAYMENT]
	@RazorpayOrderId NVARCHAR(255),
...
CREATE PROCEDURE [dbo].[SP_VALIDATE_COUPON]
	@Code NVARCHAR(50),
	@Amount DECIMAL(18,2),
	@UserId BIGINT = NULL,
	@TenantId BIGINT
...
CREATE PROCEDURE [dbo].[SP_SET_MAIN_PRODUCT_IMAGE]
    @ProductId BIGINT,
    @ImageId BIGINT,
    @UserId BIGINT = NULL,
    @TenantId BIGINT = NULL,
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_REQUEST_PASSWORD_RESET]
	@Email NVARCHAR(255),
	@IpAddress NVARCHAR(45) = NULL,
	@UserAgent NVARCHAR(500) = NULL
AS
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_VERIFY_RESET_OTP]
	@Email NVARCHAR(255),
	@OTP NVARCHAR(6),
	@NewPassword NVARCHAR(100),
	@IpAddress NVARCHAR(45) = NULL,
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_RESEND_RESET_OTP]
	@Email NVARCHAR(255),
	@IpAddress NVARCHAR(45) = NULL,
	@UserAgent NVARCHAR(500) = NULL
AS
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_SEARCH_PRODUCTS_ENHANCED]
	@TenantId BIGINT,
	@Page INT = 1,
	@Limit INT = 10,
	@Offset INT = 0,
...
-- =============================================
CREATE PROCEDURE [dbo].[SP_GET_SEARCH_SUGGESTIONS]
	@TenantId BIGINT,
	@Query NVARCHAR(100),
	@Limit INT = 8
AS
